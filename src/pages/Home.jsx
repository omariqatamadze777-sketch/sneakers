...
export default function Home() {
  // Grab top 4 featured sneakers for the home section
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-slate-500 max-w-lg mx-auto lg:mx-0">
                Discover the latest drops in lifestyle, running, and basketball sneakers from top iconic global brands.
              </p>
            ...
            <div className="relative flex justify-center">
              <div className="relative rounded-3xl bg-slate-100 p-8 w-full max-w-md shadow-xl overflow-hidden group">
                ...
                <div className="mt-4 flex justify-between items-end">
                  <div>
                    <p className="text-xs font-semibold text-indigo-600 uppercase">Nike</p>
                    <h3 className="text-xl font-bold text-slate-900">Air Max 270</h3>
                  </div>
      ...
      <section id="categories" className="py-16 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">Shop by Category</h2>
            <p className="text-sm text-slate-500 mt-1">Browse our collection by wear type</p>
          </div>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { name: "Running", count: "12 Items", bg: "bg-blue-50 text-blue-700" },
            { name: "Lifestyle", count: "24 Items", bg: "bg-emerald-50 text-emerald-700" },
            { name: "Basketball", count: "8 Items", bg: "bg-orange-50 text-orange-700" },
            { name: "Skate", count: "6 Items", bg: "bg-purple-50 text-purple-700" },
          ].map((cat, idx) => (
            <Link
              key={idx}
              to="/catalog"
            ...
            >
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm mb-4 ${cat.bg}`}>
                {cat.name[0]}
              </div>
      ...
      <section className="py-12 bg-white border-t border-slate-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">Top Trending</h2>
              <p className="text-sm text-slate-500 mt-1">Handpicked sneakers popular right now</p>
            </div>
            <Link
              to="/catalog"
          ...
          {/* Render first 4 cards from catalog */}
      ...
      <section className="py-16 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-white rounded-2xl border border-slate-100">
            ...
            <p className="text-xs text-slate-500 mt-2">Quick courier shipping directly across Georgia.</p>
          </div>
          ...
          <div className="p-6 bg-white rounded-2xl border border-slate-100">
            ...
            <p className="text-xs text-slate-500 mt-2">All shoes are verified original products only.</p>
          </div>
          ...
          <div className="p-6 bg-white rounded-2xl border border-slate-100">
            ...
            <p className="text-xs text-slate-500 mt-2">14-day hassle-free size exchange policy.</p>
          </div>
        </div>
      </section>
